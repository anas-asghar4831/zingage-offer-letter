...
export interface OfferLetterInput {
  ...
  "Offer letter share count - number of equity shares for the role. Simply write {number} Shares. E.g., 100,000 shares": number;
  ...
  "Implies what percentage stake? Simply write the %:\n.03%\n.01%": number | string;
}
