...
// Decorative ellipses shape matching Figma design (same as Page 3)
...
const benefits = [
  ...
  {
    label: "Education:",
    value: "Zingage provides a $600 annual continuing education  budget.",
    isMedium: true,
  },
  {
    label: "Equipment:",
    value: "Company-provided laptop, monitor, etc. as needed",
    isMedium: true,
  },
];

export default function Page4Benefits() {
  return (
